    ...
    <div class="portal-layout">
        ...
        <div class="dashboard-grid bottom fade-in-up delay-2">
            ...
            <div class="panel">
                ...
                <ul class="data-list">
                    <li><a href="notebooklm_cardnews.html" target="_blank">📙 NotebookLM 업무 활용법 카드뉴스</a> <span class="meta">전략기획팀</span></li>
...
$noticesContent = '
    ...
    <div class="container">
        ...
        <ul class="notice-list">
            <li onclick="alert(`공지 상세내용입니다.`)"><div><span class="title">2026년 근로자의 날 휴무 안내</span></div><span class="meta">2026.04.28</span></li>
            <li onclick="alert(`공지 상세내용입니다.`)"><div><span class="title">2026년 설날 연휴 휴무 안내</span></div><span class="meta">2026.02.10</span></li>
            <li onclick="alert(`공지 상세내용입니다.`)"><div><span class="title">2025년 크리스마스 휴무 안내</span></div><span class="meta">2025.12.20</span></li>
            <li onclick="alert(`공지 상세내용입니다.`)"><div><span class="title">2025년 광복절 연휴 및 대체휴무 안내</span></div><span class="meta">2025.08.10</span></li>
        </ul>
    </div>
'
...
$archiveContent = '
    ...
    <div class="container archive-container">
        ...
        <table class="archive-list">
            ...
            <tbody>
                <tr class="nb-highlight" onclick="window.open(`notebooklm_cardnews.html`, `_blank`);">
